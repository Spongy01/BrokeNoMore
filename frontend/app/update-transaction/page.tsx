      ...
      >
        <div className="mb-4">
          ...
          <input
            ...
            placeholder="User ID"
          />
          {errors.user_id && <p className="text-red-500 text-xs italic">{errors.user_id.message}</p>}
        </div>
        <div className="mb-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="0.00"
              style={{ paddingTop: "0.1rem" }} // Adjust padding to ensure text doesn't overlap with $
            />
          </div>
